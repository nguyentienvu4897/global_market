...
Route::group(['namespace' => 'Front'], function () {
    Route::group(['prefix' => 'client'], function () {
        ...
        // Email Verification
        Route::get('/verify/email', 'EmailVerificationController@verifyViaToken')->name('email.verify.token');
        ...
        Route::middleware('auth:client')->group(function () {
            ...
            // Email Verification
            Route::get('/email/request-verify', 'EmailVerificationController@showRequestForm')->name('email.verify.form');
            Route::post('/email/send-link', 'EmailVerificationController@sendVerificationLink')
                ->middleware('throttle.user:3,10') // 3 lần trong 10 phút
                ->name('email.verify.link.send');
        });
    });
