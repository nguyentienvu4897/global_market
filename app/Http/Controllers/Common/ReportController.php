...
class ReportController extends Controller
{
	...
	{
		return view($this->view.'.revenueReport');
	}

    public function revenueReportSearchData(Request $request)
    {
		return successResponse(
			"",
			OrderRevenueDetail::revenueReportQuery($request)->paginate($request->per_page, '', 'page', $request->current_page),
			['draw' => $request->draw]
		);
    }
