...
class Customer extends BaseModel
{
	...
	{
		return Auth::guard('admin')->user()->type == User::SUPER_ADMIN || Auth::guard('admin')->user()->type == User::QUAN_TRI_VIEN || (Auth::guard('admin')->user()->g7_id == $this->g7_id && Auth::guard('admin')->user()->type == User::G7);
	}
    ...
    public static function searchByFilter($request) {
        ...
        if(empty($request->name_mobile)) {
            ...
            if(Auth::guard('admin')->user()->type == User::NHOM_G7) {
                $g7_ids = User::find(Auth::guard('admin')->user()->id)->g7s->pluck('id');
