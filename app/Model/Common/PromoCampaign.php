...
class PromoCampaign extends BaseModel
{
	...
	public function canEdit() {
		return in_array(Auth::guard('admin')->user()->type, [User::SUPER_ADMIN, User::QUAN_TRI_VIEN]) || Auth::guard('admin')->user()->g7_id == $this->user_create->g7_id;
	}
	...
	public static function getForSelect() {
		$result = self::query();
		if (Auth::guard('admin')->user()->g7_id) {
			$ids = G7HasPromoCampaign::where('g7_id', auth()->user()->g7_id)->pluck('promo_campaign_id')->toArray();
