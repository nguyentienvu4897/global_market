    ...
    <div class="row">
        <div class="product-left-column product-images col-xs-12 col-sm-4 col-md-4 col-lg-5 col-xl-4">
            <div class="image-block large-image col_large_default">
                ...
                <img src="{{ (isset($product) && $product->image) ? $product->image->path : 'https://placehold.co/480x480' }}" id="product-featured-image-quickview" class="img-responsive product-featured-image-quickview" alt="quickview">
                </a>
                </span>
