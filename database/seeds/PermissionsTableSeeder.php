...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::createRecord(['id' => 7, 'name' => 'Thêm hàng hóa', 'display_name' => 'Tạo mới', 'group' => 'Quản lý hàng hóa'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 8, 'name' => 'Sửa hàng hóa', 'display_name' => 'Sửa', 'group' => 'Quản lý hàng hóa'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 9, 'name' => 'Xóa hàng hóa', 'display_name' => 'Xóa', 'group' => 'Quản lý hàng hóa'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        ...
        Permission::createRecord(['id' => 13, 'name' => 'Thêm mã giảm giá', 'display_name' => 'Tạo mới', 'group' => 'Danh mục mã giảm giá'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 14, 'name' => 'Sửa mã giảm giá', 'display_name' => 'Sửa', 'group' => 'Danh mục mã giảm giá'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 15, 'name' => 'Xóa mã giảm giá', 'display_name' => 'Xóa', 'group' => 'Danh mục mã giảm giá'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        ...
        Permission::createRecord(['id' => 32, 'name' => 'Quản lý đơn hàng', 'display_name' => 'Quản lý', 'group' => 'Quản lý đơn hàng'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 33, 'name' => 'Xuất excel đơn hàng', 'display_name' => 'Xuất excel', 'group' => 'Quản lý đơn hàng'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 34, 'name' => 'Import excel đơn hàng', 'display_name' => 'Import excel', 'group' => 'Quản lý đơn hàng'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 35, 'name' => 'Xem chi tiết đơn hàng', 'display_name' => 'Xem chi tiết', 'group' => 'Quản lý đơn hàng'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 36, 'name' => 'Cập nhật trạng thái đơn hàng', 'display_name' => 'Cập nhật trạng thái', 'group' => 'Quản lý đơn hàng'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::NGUOI_BAN_HANG, User::CONG_TAC_VIEN]);
        ...
        // Cộng tác viên
        Permission::createRecord(['id' => 48, 'name' => 'Quản lý đăng ký cộng tác viên', 'display_name' => 'Quản lý', 'group' => 'Quản lý đăng ký cộng tác viên'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN]);
        Permission::createRecord(['id' => 49, 'name' => 'Duyệt đăng ký cộng tác viên', 'display_name' => 'Duyệt', 'group' => 'Quản lý đăng ký cộng tác viên'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN]);

        // Link affiliate
        Permission::createRecord(['id' => 50, 'name' => 'Quản lý yêu cầu affiliate link', 'display_name' => 'Quản lý', 'group' => 'Quản lý yêu cầu affiliate link'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 51, 'name' => 'Cập nhật trạng thái yêu cầu affiliate link', 'display_name' => 'Cập nhật trạng thái', 'group' => 'Quản lý yêu cầu affiliate link'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::CONG_TAC_VIEN]);
        Permission::createRecord(['id' => 52, 'name' => 'Gửi email xác nhận yêu cầu affiliate link', 'display_name' => 'Gửi email', 'group' => 'Quản lý yêu cầu affiliate link'], [User::SUPER_ADMIN, User::QUAN_TRI_VIEN, User::CONG_TAC_VIEN]);
